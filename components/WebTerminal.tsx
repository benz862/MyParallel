             ...
             <div className="bg-white rounded-3xl shadow-sm border border-slate-200 p-2 sm:p-6 lg:p-8 h-full custom-scrollbar relative overflow-hidden">
              ...
              <div className="mb-6 mt-2">
                <div className="flex items-center gap-1 mb-4 flex-wrap">
                  ...
                  <button onClick={() => setActiveRightTab('messages')} className={`px-4 py-2 rounded-xl text-sm font-bold transition-colors ${activeRightTab === 'messages' ? 'bg-wellness-blue text-white shadow-sm' : 'bg-slate-100 text-slate-600 hover:bg-slate-200'}`}>💬 Messages</button>
              ...
              <div className="overflow-x-auto pb-4">
                ...
                ) : activeRightTab === 'messages' && selectedPatientId ? (
                  <CareMessageFeed patientId={selectedPatientId} />
                ) : selectedPatientId ? (
